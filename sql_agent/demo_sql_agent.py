...
def run_demo():
    ...
    from sql_agent.data import schema_config
    ...
    # — 重新加载 schema —
    from sql_agent.schema_loader import SchemaLoader
    import sql_agent.schema_loader as sl
    import sql_agent.sql_validator as sv
