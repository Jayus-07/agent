...
interface Props { messages: Message[]; isLoading: boolean; sessionId?: string; budgetBlocked?: boolean }
 ...
 */
export default function MessageList({ messages, isLoading, sessionId, budgetBlocked = false }: Props) {
      ...
      {messages.map((msg, i) => {
        ...
        return (
          <Fragment key={msg.id}>
            ...
            />
            {isLoading && i === lastUserIdx && <ProgressCards />}
          </Fragment>
        )
      })}
    </div>
