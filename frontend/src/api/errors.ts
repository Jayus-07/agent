...
function extractIdempotencyKey(err: unknown): string | undefined {
  if (!err || typeof err !== "object") return undefined;
  const key = (err as { idempotencyKey?: unknown }).idempotencyKey;
...
function resolveDescriptor(
  ...
  return {
    ...
    details: payload.details && typeof payload.details === "object"
      ...
      : undefined,
    idempotencyKey: extractIdempotencyKey(err),
    cause: err,
  };
}
