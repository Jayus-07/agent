...
from report_agent.data_fetcher import (
    REPORT_REGISTRY, get_fetcher, SQLFetcher, APIFetcher,
)
from report_agent.template_engine import TemplateEngine
from report_agent.snapshot import save_snapshot, cleanup_old_snapshots
...
def _get_chart_generator():
    ...
    if _chart_generator is None:
        from report_agent.chart_generator import chart_generator as cg
        _chart_generator = cg
...
def _get_llm_polisher():
    ...
    if _llm_polisher is None:
        from report_agent.llm_polisher import llm_polisher as lp
        _llm_polisher = lp
