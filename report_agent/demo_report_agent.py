...
def run_demo():
    ...
    # ── 注册演示报告类型 ──
    from report_agent.data_fetcher import register_report_type, REPORT_REGISTRY
    ...
    from report_agent import ReportGenerator, generate_report
    ...
    from report_agent.snapshot import list_snapshots, load_latest_snapshot
