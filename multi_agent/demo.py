...
def create_demo_schema():
    ...
    try:
        ...
        from sql_agent.schema_loader import schema_loader as sl
        # 先移除标准表名
...
def destroy_demo_schema(tables: dict):
    try:
        ...
        from sql_agent.data.schema_config import SCHEMA_CONFIG
...
def register_demo_reports(tables):
    from report_agent.data_fetcher import register_report_type
