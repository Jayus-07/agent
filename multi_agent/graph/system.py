...
from multi_agent.graph.builder import build_graph, _parse_event
...
class MultiAgentSystem:
    ...
    def _extract_sources(step_results: dict, final_answer: str) -> list[dict]:
        from multi_agent.reporter.reporter import _extract_sources_from_steps
        from multi_agent.reporter.context_filter import _parse_sources_from_text
