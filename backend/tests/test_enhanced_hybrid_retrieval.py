...
class TestUltimateRRFFusion:
    ...
    def test_fusion_keeps_docs_without_chunk_type_marker(self):
        ...
        merged = _ultimate_rrf_fusion(self._docs(), rrf_k=60, top_k=5)
        assert len(merged) == 3
    ...
    def test_fusion_dedups_by_chunk_id(self):
        ...
        merged = _ultimate_rrf_fusion(docs, rrf_k=60, top_k=5)
    ...
    def test_fusion_respects_top_k(self):
        ...
        merged = _ultimate_rrf_fusion(self._docs(), rrf_k=60, top_k=2)
        assert len(merged) == 2
