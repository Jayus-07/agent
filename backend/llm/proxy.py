...
核心设计:
  ...
  - 所有调用方 `from backend.llm import llm` 无需修改
"""
import threading
...
def _build_default_llm():
    ...
    with _default_lock:
        ...
        if provider == "ollama":
            ...
            from backend.llm.providers.deepseek import build_deepseek
            _default_llm = build_deepseek(LLM_MODEL)
        elif provider == "minimax":
            from backend.llm.providers.minimax import build_minimax
