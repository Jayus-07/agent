...
def write_markdown_report(
    ...
    if perf:
        ...
        if perf.get("total_prompt_tokens"):
            lines.append(f"| Prompt Token 消耗 | {perf['total_prompt_tokens']:,} |")
        if perf.get("total_completion_tokens"):
            lines.append(f"| Completion Token 消耗 | {perf['total_completion_tokens']:,} |")
        lines.append("")
    else:
